...
function setLightColor() {
	$("#page").style.backgroundColor = "rgba(85,85,85,".concat(getDayLight(), ")"), (new Date).getHours() < 17 && (signatureEl.style.color = "#666")
}
function typeSignature() {
	typeSignature.count = typeSignature.count || 0, typeSignature.count <= signature.length ? (signatureEl.innerHTML = "".concat(signature.slice(0, typeSignature.count++), "|"), setTimeout(typeSignature, 140)) : signatureEl.innerHTML = signature
}
function messenger(i) {
	var o = this,
		...
		e = 0;
	o.init = function() {
		o.codeletters = "&#*+%?￡@§$", o.message = 0, o.currentLength = 0, o.fadeBuffer = !1, o.messages = ["..."], setTimeout(o.animateIn, 100)
	}, o.generateRandomString = function(e) {
		for (var t = ""; t.length < e;) t += o.codeletters.charAt(Math.floor(Math.random() * o.codeletters.length));
		return t
		...
		if (!1 === o.fadeBuffer) {
			o.fadeBuffer = [];
			for (var e = 0; e < o.messages[o.message].length; e++) o.fadeBuffer.push({
		...
		o.message = o.message + 1, o.message >= o.messages.length && (o.message = 0), o.currentLength = 0, o.fadeBuffer = !1, i.innerHTML = "", setTimeout(o.animateIn, 200)
	}, o.init()
}
function loadMain() {
	loadMain.loaded || (setLightColor(), setTimeout(function() {
		$(".card-inner").classList.add("in"), new messenger(signatureEl)
	}, 400), loadMain.loaded = !0)
}
function loadAll() {
...
var enterEl = $(".enter");
enterEl.addEventListener("click", loadAll), enterEl.addEventListener("touchenter", loadAll), document.body.addEventListener("mousewheel", loadAll, {
	passive: !0
}), $(".arrow").addEventListener("mouseenter", loadAll), isPhone && (document.addEventListener("touchstart", function(e) {
